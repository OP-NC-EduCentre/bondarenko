...
L026	10 / 8	Reference 'O.CODE' refers to table/view not found in the FROM clause or found in ancestor statement.
L014	10 / 10	Unquoted identifiers must be consistently lower case.
L026	10 / 15	Reference 'A.ATTR_ID' refers to table/view not found in the FROM clause or found in ancestor statement.
L014	10 / 17	Unquoted identifiers must be consistently lower case.
L026	10 / 25	Reference 'A.CODE' refers to table/view not found in the FROM clause or found in ancestor statement.
L014	10 / 27	Unquoted identifiers must be consistently lower case.
L026	10 / 32	Reference 'A.NAME' refers to table/view not found in the FROM clause or found in ancestor statement.
...
L036	67 / 1	Select targets should be on a new line unless there is only one select target.
